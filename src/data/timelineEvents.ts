...
export const TIMELINE_EVENTS: TimelineEvent[] = [
  {
    ...
    details: {
      ar: [
        ...
        "",
        "ضمن هذه الفترة برزت محطات رئيسية:",
  ...
  },
  {
    ...
    details: {
      ar: [
        "خلال 16–30 نونبر 2025، برزت حوادث مؤلمة اعتُبرت مؤشرات على أزمة بنيوية في الخدمات العمومية والبنية التحتية.",
        "",
        "محطات مذكورة:",
        "• 21 نونبر: وفاة رضيع بسبب انقطاع التيار الكهربائي.",
        "• 25 نونبر: وفاة طفلة داخل قسم مستعجلات.",
        "• 28 نونبر: احتجاجات ميدانية وارتفاع المطالب السياسية.",
        "• 29 نونبر: تصريح سياسي يدعو إلى عفو عام ووقف الاعتقالات.",
      ].join("\n"),
      en: [
        "During Nov 16–30, 2025, painful incidents highlighted structural problems in infrastructure and public services.",
        "",
        "Noted moments:",
        "• Nov 21: An infant’s death linked to a power outage.",
        "• Nov 25: A child’s death inside an emergency department.",
        "• Nov 28: Street protests and rising political demands.",
        "• Nov 29: A political statement calling for a general amnesty and an end to arrests.",
      ].join("\n"),
      fr: [
        "Entre le 16 et le 30 novembre 2025, des incidents graves ont mis en évidence un problème structurel des services et infrastructures.",
        "",
        "Moments cités :",
        "• 21 nov. : décès d’un nourrisson lié à une coupure de courant.",
        "• 25 nov. : décès d’une enfant aux urgences.",
        "• 28 nov. : protestations et hausse des revendications politiques.",
        "• 29 nov. : appel politique à une amnistie générale et à l’arrêt des arrestations.",
      ].join("\n"),
    },
    keyPoints: [
      {
  ...
  },
  {
    ...
    details: {
      ar: [
        "خلال 30 أكتوبر – 15 نونبر 2025، تواصلت المبادرات الحقوقية والشعبية لدعم المعتقلين والتنديد بالعنف، مع محطات رئيسية:",
      ...
      en: [
        "Between Oct 30 and Nov 15, 2025, rights and civil initiatives supported detainees and condemned violence:",
      ...
      fr: [
        "Du 30 oct. au 15 nov. 2025, des initiatives citoyennes et de droits humains se sont poursuivies :",
  ...
  },
  {
    ...
    summary: {
      ar: "سُجّلت خلال هذه الفترة خسائر بشرية (3 وفيات) وجرحى في سياق التوتر، مع ارتفاع الغضب الشعبي.",
      en: "This period recorded 3 deaths and injuries, contributing to public anger.",
      fr: "Cette période a enregistré 3 décès et des blessés, alimentant la colère.",
    },
    location: {
    ...
    details: {
      ar: [
        "شهدت نهاية شتنبر وبداية أكتوبر أولى الخسائر البشرية داخل مسار الاحتجاجات:",
        "• 30 شتنبر: وفاة أمين ن. في وجدة مع تسجيل حادث «دهس/قمع».",
        "• 2 أكتوبر: وفاة 3 مواطنين في القليعة (قرب أكادير) وجرح سبعة آخرين بسبب سيول/فيضانات مفاجئة.",
        "",
        "شكّلت هذه المحطة عامل تصعيد عاطفي وسياسي وتوسيع دائرة الغضب.",
      ].join("\n"),
      en: [
        "Early human losses were recorded at the end of September / start of October:",
        "• Sep 30: Death of Ameen N. in Oujda, linked to a repression/vehicle incident.",
        "• Oct 2: Three deaths in Lqliaa (near Agadir) and seven injured due to sudden floods.",
        "",
        "This moment is presented as a driver of emotional and political escalation.",
      ].join("\n"),
      fr: [
        "Des pertes humaines ont été enregistrées fin sept./début oct. :",
        "• 30 sept. : décès d’Amin N. à Oujda, associé à un incident de répression.",
        "• 2 oct. : trois décès à Lqliaa (près d’Agadir) et sept blessés suite à des crues soudaines.",
        "",
        "Cette étape est présentée comme un facteur d’escalade émotionnelle et politique.",
      ].join("\n"),
    },
    keyPoints: [
      { ar: "3 وفيات خلال الفترة", en: "3 deaths during the period", fr: "3 décès durant la période" },
  ...
  },
  {
    ...
    summary: {
      ar: "بعد خروج الاحتجاجات للشارع، سُجلت اعتقالات واسعة ومحاكمات سريعة وأحكام سالبة للحرية.",
      en: "After street protests, reports cited wide arrests, fast-track trials, and prison sentences.",
      fr: "Après les protestations, des rapports ont évoqué des arrestations massives, des procès accélérés et des peines de prison.",
    },
    location: { ar: "مدن متعددة", en: "Multiple cities", fr: "Plusieurs villes" },
    details: {
      ar: [
        "أشارت معطيات الحركة وتغطيات حقوقية إلى انتقال السلطات إلى مرحلة قمعية عبر:",
        "• اعتقالات واسعة (“أكثر من 400” في الأيام الأولى).",
        "• تسجيل أكثر من 2068 حالة اعتقال/متابعة وفق تقارير مستقلة.",
        "• محاكمات عاجلة وأحكام وُصفت بأنها “قاسية”.",
        "",
        "ملاحظة: هذه الأرقام مستندة إلى معطيات أعضاء الحركة والتقارير المستقلة وروابط المصادر المدرجة.",
      ].join("\n"),
      en: [
        "Movement reports and rights coverage indicated a shift toward repression via:",
        "• Broad arrests (“400+” early on).",
        "• “2068+” arrest/prosecution cases cited in independent reporting.",
        "• Fast-track trials and sentences described as harsh.",
        "",
        "Note: figures are based on movement member reporting, independent sources, and the linked references.",
      ].join("\n"),
      fr: [
        "Les données du mouvement et des couvertures droits humains décrivent une phase répressive :",
        "• Arrestations massives (« 400+ » au début).",
        "• « 2068+ » cas d’arrestation/poursuite cités via des sources indépendantes.",
        "• Procès accélérés et peines décrites comme sévères.",
        "",
        "Note : ces chiffres sont basés sur les données des membres du mouvement, des sources indépendantes et les liens fournis.",
      ].join("\n"),
    },
    keyPoints: [
      { ar: "400+ اعتقال مبكر", en: "400+ early arrests", fr: "400+ arrestations initiales" },
      { ar: "2068+ حالات اعتقال/متابعة", en: "2068+ cases", fr: "2068+ cas" },
  ...
  },
  {
    ...
    summary: {
      ar: "شهدت نهاية شتنبر خروج مظاهرات في أكثر من 10–11 مدينة، مطالبةً بالعدالة الاجتماعية ومحاربة الفساد وتحسين الخدمات.",
      en: "Late September saw street protests in 10–11+ cities, calling for social justice, anti-corruption, and better services.",
      fr: "Fin septembre : manifestations dans 10–11+ villes, pour justice sociale, anti-corruption et services publics.",
    },
    location: {
    ...
    details: {
      ar: [
        "شكّلت الاحتجاجات الميدانية يومي 27 و28 شتنبر 2025 نقطة تحول، مع ترديد مطالب أساسية مثل:",
        "• تحسين الخدمات العامة (الصحة والتعليم والسكن).",
        "• محاربة الفساد وربط المسؤولية بالمحاسبة.",
        "• العدالة الاجتماعية والكرامة.",
        "",
        "وجاءت هذه المحطة بعد تفاعل رقمي متسارع داخل Discord وسياق تصاعد الغضب بعد حادث “مستشفى الموت”.",
      ].join("\n"),
      en: [
        "Sep 27–28 street protests marked a turning point with core demands such as:",
      ...
      fr: [
        "Les 27–28 sept. ont marqué un tournant avec des revendications :",
    ...
    keyPoints: [
      { ar: "احتجاجات في 10–11+ مدينة", en: "10–11+ cities", fr: "10–11+ villes" },
  ...
  },
  {
    ...
    summary: {
      ar: "اعتُبر اعتقال أحد الوجوه البارزة قبل موعد الاحتجاجات إشارة إلى محاولة تطويق الحراك قبل نزوله للشارع.",
      en: "An arrest of a prominent figure ahead of protests was seen as an attempt to contain mobilization early.",
      fr: "L’arrestation d’une figure avant les protestations a été perçue comme une tentative d’endiguement.",
    },
    location: { ar: "كلميم / الدار البيضاء", en: "Guelmim / Casablanca", fr: "Guelmim / Casablanca" },
    details: {
      ar: [
        "تتضمن المعطيات اعتقال “محمد بزيغ” يوم 26 شتنبر 2025 قبل موعد الاحتجاجات المعلنة، باعتباره محطة ضمن سياق القمع الاستباقي.",
        "يُقدَّم الحدث كرسالة ردع مبكرة قبل خروج المظاهرات.",
      ].join("\n"),
      en: [
        "Reports mention the Sep 26 arrest of “Mohamed Bzegh” ahead of announced protests, as a pre-emptive deterrence step.",
      ].join("\n"),
      fr: [
        "Les rapports mentionnent l’arrestation du 26 sept. de « Mohamed Bzegh » avant les protestations annoncées, comme une mesure de dissuasion préventive.",
      ].join("\n"),
    },
    sources: [
  ...
  },
  {
    ...
    summary: {
      ar: "بدأت الحركة تتخذ شكلًا تنظيميًا عبر إنشاء سيرفر Discord وبناء أولى اللجان والتنسيق.",
      en: "The movement took a more organized form via a Discord server and early committee building.",
      fr: "Le mouvement a pris une forme plus structurée via un serveur Discord et la mise en place des premiers comités.",
    },
    location: { ar: "فضاء رقمي (Discord)", en: "Online (Discord)", fr: "En ligne (Discord)" },
    details: {
      ar: [
        "كان تأسيس Discord يوم 15 شتنبر بداية “الهيكلة” العملية: قنوات للتنسيق، فرق عمل، وآليات تواصل داخلية.",
        "هذه المرحلة تُقدَّم باعتبارها نقطة انتقال من التعاطف إلى التنظيم.",
      ].join("\n"),
      en: [
        "Sep 15 marked the start of practical structuring through Discord: coordination channels, work teams, and internal communication routines.",
      ].join("\n"),
      fr: [
        "Le 15 sept. marque le début de la structuration via Discord : canaux de coordination, équipes, et routines internes.",
      ].join("\n"),
    },
    sources: [
  ...
  },
  {
    ...
    details: {
      ar: [
        "شهد 14 شتنبر 2025 أول خروج احتجاجي في أكادير كرد مباشر على “مستشفى الموت”، مع رفع مطالب مرتبطة بالمحاسبة وتحسين الخدمات الصحية.",
      ].join("\n"),
      en: [
        "Sep 14 marked the first street mobilization in Agadir responding to the hospital deaths and calling for accountability and healthcare improvements.",
      ].join("\n"),
      fr: [
        "Le 14 sept. marque la première mobilisation à Agadir en réaction à l’affaire de l’hôpital et pour l’amélioration de la santé et la responsabilité.",
      ].join("\n"),
    },
    sources: [
  ...
  },
  {
    ...
    summary: {
      ar: "سُجلت وفاة ما بين 13 و26 شخصًا في المستشفى الجهوي الحسن الثاني بأكادير في ظرف وجيز، ما فجّر موجة غضب واسعة.",
      en: "Reports recorded 13–26 deaths at Hassan II Regional Hospital in Agadir in a short time, triggering widespread outrage.",
      fr: "Les rapports ont fait état de 13–26 décès à l’hôpital Hassan II d’Agadir sur une courte période, déclenchant l’indignation.",
    },
    location: { ar: "أكادير", en: "Agadir", fr: "Agadir" },
    details: {
      ar: [
        "كان 25 غشت 2025 لحظة صدمة بعد تداول أخبار حول وفيات عديدة في المستشفى الجهوي الحسن الثاني بأكادير في ظرف زمني قصير.",
        "تم تقديم الحدث كبداية غضب اجتماعي واسع حول جودة الخدمات الصحية وربط المسؤولية بالمحاسبة.",
        "",
        "ملاحظة: نطاق العدد (13–26) مستند إلى معطيات أعضاء الحركة وروابط المصادر المدرجة.",
      ].join("\n"),
      en: [
        "Aug 25, 2025 was a shock moment after reports of multiple deaths in a short period at Hassan II Regional Hospital in Agadir.",
        "It is presented as the starting point of broader anger about healthcare quality and accountability.",
        "",
        "Note: the 13–26 range is based on movement member reporting and the linked sources.",
      ].join("\n"),
      fr: [
        "Le 25 août 2025 a marqué un choc après des informations sur plusieurs décès sur une courte période à l’hôpital Hassan II d’Agadir.",
        ...
        "",
        "Note : la fourchette 13–26 est basée sur les données des membres du mouvement et les liens fournis.",
      ].join("\n"),
    },
    sources: [
