            ...
            <div className="container mx-auto px-4 py-32 max-w-5xl">
                ...
                <div className="relative">
                    ...
                    {timelineData.map((item, index) => (
                        ...
                        >
                            {/* Content Card */}
                            <div
                                className={`w-full md:w-[45%] ${index % 2 === 0 ? "md:pr-12 md:text-right" : "md:pl-12"
                                    }`}
                            >
                ...
                >
                    {[
                        ...
                        <div key={i} className="bg-[var(--surface)]/50 border border-[var(--border)] rounded-lg p-4 text-center">
                            <p className="text-2xl font-display font-bold text-neon-red">{stat.value}</p>
                            <p className="text-xs text-[var(--text-secondary)] uppercase tracking-widest">{t(stat.labelKey)}</p>
                        </div>
                    ))}
                </motion.div>
            </div>
